var SEARCH_DATA = [
  ...
  { title: "Доступ в OneID для услуг Трастбанка", desc: "Разрешение на обработку персональных данных, id.egov.uz, Управление данными, OneID", url: "pages/oneid.html", cat: "Начало работы" },
